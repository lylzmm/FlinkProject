 ...
 * countWindow(4, 2)
 */
public class case02_CountWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<Tuple2<String, Integer>, Tuple, GlobalWindow> stream = keyedStream.countWindow(4, 2);
        stream.reduce(new ReduceFunction<Tuple2<String, Integer>>() {
            @Override
