 ...
 * countWindow(10)
 */
public class case01_CountWindow {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<Tuple2<String, Integer>, Tuple, GlobalWindow> stream = keyedStream.countWindow(10);
        SingleOutputStreamOperator<Tuple2<String, Integer>> reduce = stream.reduce(new ReduceFunction<Tuple2<String, Integer>>() {
            @Override
